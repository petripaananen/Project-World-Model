...
- Audits the **Causal Digital Twin** using the interactive **3D Classical Garden Simulation** (DTO Simulation), where project health and integration debt are mapped onto organic elements (well water, flowering PR bushes, wilted Issue weeds, and orbiting agent butterflies).
